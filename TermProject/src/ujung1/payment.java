...
import hyun.seung.kim.Dispatcher;
import hyun.seung.kim.MyDB;
...
public class payment extends JFrame {
	...
	public payment(String MovieName, String screenNum,String playTime, String playDate, int [] reserveSeatNum, int sNum, int selectcount) {
